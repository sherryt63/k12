...
export default {
  data() {
    return {
      ...
      optionPercentages: {},
      staticData: {
        'PART1_I_1': { image: '/images/PART1_I_1.png', difficulty: '一颗星' },
        'PART1_I_2': { image: '/images/PART1_I_2.png', difficulty: '一颗星' },
        'PART1_I_3': { image: '/images/PART1_I_3.png', difficulty: '一颗星' },
        'PART1_I_4': { image: '/images/PART1_I_4.png', difficulty: '一颗星' },
        'PART1_I_5': { image: '/images/PART1_I_5.png', difficulty: '一颗星' },
        'PART1_I_6': { image: '/images/PART1_I_6.png', difficulty: '一颗星' }
      },
      classOptions: []
    };
  },
