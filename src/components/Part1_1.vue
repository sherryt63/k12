<template>
  <div class="main">
    <header class="header">
      <h2>I.Listen and tick (听一听，在听到的图片下打勾）：</h2>
      <h2>【词汇-词义】</h2>
      <div class="menu">
      ...
      <div class="part-background">
        ...
        <div class="question-wrapper">
          <div class="left-column">
            ...
            <div class="title">
              <p
                :class="{ wrong: permission === '1' && questionData[question]?.studentAnswer !== questionData[question]?.correctAnswer }">
                {{ index + 1 }}、 {{ staticData[question]?.difficulty }}</p>
            </div>
            <img :src="staticData[question]?.image" class="image" />
            ...
            <div class="correct_answer">
              <p style="font-size:18px">正确答案：<span
                  v-html="highlightText(questionData[question]?.correctAnswer, questionData[question]?.correctAnswer)"></span>
              </p>
            </div>
          ...
          <div class="right-column table-container">
            ...
            <div v-if="permission === '0'">
              <table class="custom-border" border="1" cellspacing="0" width="600px" height="175px" bgcolor="white">
                <tbody>
                  <tr>
                    <td style="width: 50%; text-align: center; color: black; font-size:17px">选项</td>
                    <td style="height: 25%; text-align: center; color: black; font-size:17px">作答率</td>
                  </tr>
                  <tr>
                    <td style="height: 25%; text-align: center; color: black; font-size:17px"
            ...
            <div v-if="permission === '1'">
              <table class="custom-border" border="1" cellspacing="0" width="500px" height="160px" bgcolor="white">
                <tbody>
                  <tr>
                    <td style="height: 50%; width: 33.333%; text-align: center; color: black; font-size:17px">选项</td>
                    <td style="width: 33.333%; text-align: center; color: black; font-size:17px"
                      v-for="(option, optIndex) in options" :key="optIndex">
                      <span v-html="highlightText(option.text, questionData[question]?.correctAnswer)"></span>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="3" style="color: black; font-size:17px">
                      <p class="option-percentages-container">&nbsp;&nbsp;&nbsp;&nbsp;学生答案：{{
                        questionData[question]?.studentAnswer }}</p>
                      <p class="option-percentages-container">&nbsp;&nbsp;&nbsp;&nbsp;同伴正确率：{{
                        questionData[question]?.peerAccuracy }}%</p>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div v-if="permission === '2'">
              <!--单个班级表格-->
              <table v-if="compareType === 'single'" class="custom-border" border="1" cellspacing="0" width="600px" height="175px" bgcolor="white">
              <tbody>
                  <tr>
                    <td style="width: 50%; text-align: center; color: black; font-size:17px">选项</td>
                    <td style="height: 25%; text-align: center; color: black; font-size:17px">作答率</td>
                  ...
                  <!--两个班级对比表格-->
                  <table v-if="compareType === 'double-class'" class="custom-border" border="1" cellspacing="0" width="600px" height="175px" bgcolor="white">
                  <tbody>
                  <tr>
              ...
              <!--两个校区对比表格-->
                  <table v-if="compareType === 'double-campus'" class="custom-border" border="1" cellspacing="0" width="600px" height="175px" bgcolor="white">
                  <tbody>
                  <tr>
                    <td rowspan=2 style="width: 33.33%; text-align: center; color: black; font-size:17px">选项</td>
                    <td colspan=2 style="height: 25%; text-align: center; color: black; font-size:17px">作答率</td>
...
export default {
  data() {
    return {
      questions: ['PART1_I_1', 'PART1_I_2', 'PART1_I_3', 'PART1_I_4', 'PART1_I_5', 'PART1_I_6'],
      listeningText: '',
      correctAnswer: '',
      studentAnswer: '',
      peerAccuracy: 0,
      ...
      optionPercentages: {},
      staticData: {
        'PART1_I_1': { image: '/images/PART1_I_1.png', difficulty: '★' },
        'PART1_I_2': { image: '/images/PART1_I_2.png', difficulty: '★' },
        'PART1_I_3': { image: '/images/PART1_I_3.png', difficulty: '★' },
        'PART1_I_4': { image: '/images/PART1_I_4.png', difficulty: '★' },
        'PART1_I_5': { image: '/images/PART1_I_5.png', difficulty: '★' },
        'PART1_I_6': { image: '/images/PART1_I_6.png', difficulty: '★' }
      },
      classOptions: []
    };
  },
