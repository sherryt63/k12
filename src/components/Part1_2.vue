<template>
    <div>
        <h2>Ⅱ. Listen and choose（听一听，选出听到的内容，将字母代号写在前面的括号内）：【语音-基本读音】</h2>
...
export default {
    data() {
        return {
            ...
            optionPercentages: {},
            staticData: {
                'PART1_II_1': { difficulty: '一颗星' },
                'PART1_II_2': { difficulty: '两颗星' },
                'PART1_II_3': { difficulty: '两颗星' },
                'PART1_II_4': { difficulty: '两颗星' },
                'PART1_II_5': { difficulty: '两颗星' },
