<template>
  <div class="main">
   <header class="header">
    <h2>Ⅳ. Listen and number（听一听，用“1 ~5”给下列图片编号）：</h2>
    <h2>【词汇-词义】</h2>
    <div class="menu">
          ...
          <!--教师端-->
            ...
            <div v-if="permission === '1'">
              <table class="custom-border" border="1" cellspacing="0" width="500px" height="160px" bgcolor="white">
                <tbody>
                  <tr>
                    <td style="height: 50%; width: 15%; text-align: center; color: black; font-size:17px">选项</td>
                    <td style="width: 15%; text-align: center; color: black; font-size:17px"
                      v-for="(option, optIndex) in options" :key="optIndex">
                      <span v-html="highlightText(option.text, questionData[question]?.correctAnswer)"></span>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="6" style="color: black; font-size:17px">
