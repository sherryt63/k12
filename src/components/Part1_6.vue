<template>
    <div class="main">
      <header class="header">
        <h2>Ⅵ. Listen and choose（听一听，选出合适的应答句，将字母代号写在前面的括号内）：</h2>
        <h2>【语音-基本读音】</h2>
        <div class="menu">
        ...
        <div class="right-column table-container"> 
          ...
          <div v-if="permission === '1'">
            ...
            <tr>
              ...
              <td style="width: 25%; text-align: center; color: black; font-size:16px"
    ...
    data() {
        return {
            ...
            staticConOption: {
                ...
                'PART1_VI_3': { confuse: '' },
                'PART1_VI_4': { confuse: '' },
                'PART1_VI_5': { confuse: 'B' }
            },
            questionDescriptions: {
                'PART1_VI_1': 'A. There are five.  &nbsp;&nbsp;B. Five yuan.  &nbsp;&nbsp;C. Five years old.',
                'PART1_VI_2': 'A. Yes. I like robots.  &nbsp;&nbsp;B. No. I like robots.  &nbsp;&nbsp;C. I like robots.',
                'PART1_VI_3': "A. It's a scarf.  &nbsp;&nbsp;B. There are five scarves.  &nbsp;&nbsp;C. They're scarves.",
                'PART1_VI_4': 'A. Yes, I can.  &nbsp;&nbsp;B. Yes, I am.  &nbsp;&nbsp;C. Yes, I do.',
                'PART1_VI_5': 'A. I go to the zoo.  &nbsp;&nbsp;B. I can go to the zoo.  &nbsp;&nbsp;C. Yes. I go to the zoo.',
            },
            classOptions: []
        };
    },
