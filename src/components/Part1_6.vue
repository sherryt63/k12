<template>
    <div>
        <h2>Ⅵ. Listen and choose（听一听，选出合适的应答句，将字母代号写在前面的括号内）：【语音-基本读音】</h2>
...
export default {
    data() {
        return {
            questions: ['PART1_VI_1', 'PART1_VI_2', 'PART1_VI_3', 'PART1_VI_4', 'PART1_VI_5'],
            listeningText: '',
            correctAnswer: '',
            studentAnswer: '',
            peerAccuracy: 0,
            ...
            optionPercentages: {},
            staticData: {
                'PART1_VI_1': { difficulty: '两颗星' },
                'PART1_VI_2': { difficulty: '两颗星' },
                'PART1_VI_3': { difficulty: '两颗星' },
                'PART1_VI_4': { difficulty: '两颗星' },
                'PART1_VI_5': { difficulty: '两颗星' }
            },
            questionDescriptions: {
                'PART1_VI_1': '(   ) 1. A. There are five.			<span class="highlighted">B. Five yuan.</span>				C. Five years old.',
                'PART1_VI_2': '(   ) 2. <span class="highlighted">A. Yes. I like robots.</span>		B. No. I like robots.    	C. I like robots.',
                'PART1_VI_3': '(   ) 3. A. It’s a scarf.         	B. There are five scarves.  <span class="highlighted">C. They’re scarves.</span>',
                'PART1_VI_4': '(   ) 4. A. Yes, I can.   			<span class="highlighted">B. Yes, I am.</span>	        	C. Yes, I do.',
                'PART1_VI_5': '(   ) 5. <span class="highlighted">A. I go to the zoo.</span>  		<span class="highlightedCon">B. I can go to the zoo.</span>  	C. Yes. I go to the zoo.',
            },
            classOptions: []
        };
    },
