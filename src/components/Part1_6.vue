    ...
    data() {
        return {
            ...
            questionDescriptions: {
                'PART1_VI_1': '(   ) 1. A. There are five.			B. Five yuan.				C. Five years old.',
                'PART1_VI_2': '(   ) 2. A. Yes. I like robots.		B. No. I like robots.    	C. I like robots.',
                'PART1_VI_3': '(   ) 3. A. It’s a scarf.         	B. There are five scarves.  C. They’re scarves.',
                'PART1_VI_4': '(   ) 4. A. Yes, I can.   			B. Yes, I am.	        	C. Yes, I do.',
                'PART1_VI_5': '(   ) 5. A. I go to the zoo.  		B. I can go to the zoo.  	C. Yes. I go to the zoo.',
            },
            classOptions: []
        };
    },
