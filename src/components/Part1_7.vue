...
export default {
    data() {
        return {
            ...
            optionPercentages: {},
            staticData: {
                'PART1_VII_1': { image: '/images/PART1_VII_1.png', difficulty: '两颗星' },
                'PART1_VII_2': { image: '/images/PART1_VII_2.png', difficulty: '两颗星' },
                'PART1_VII_3': { image: '/images/PART1_VII_3.png', difficulty: '两颗星' },
                'PART1_VII_4': { image: '/images/PART1_VII_4.png', difficulty: '两颗星' },
                'PART1_VII_5': { image: '/images/PART1_VII_5.png', difficulty: '两颗星' },
                'PART1_VII_6': { image: '/images/PART1_VII_6.png', difficulty: '两颗星' }
            },
            classOptions: []
        };
    },
