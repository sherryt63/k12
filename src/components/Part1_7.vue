<template>
    <div class="main">
      <header class="header">
        <h2>Ⅶ.Listen and draw（听一听，判断下列图片是否符合听到的内容，用或表示）：</h2>
        <h2>【词汇-词义】</h2>
        <div class="menu">
...
export default {
    data() {
        return {
            questions: ['PART1_VII_1', 'PART1_VII_2', 'PART1_VII_3', 'PART1_VII_4', 'PART1_VII_5'],
            listeningText: '',
            correctAnswer: '',
            studentAnswer: '',
            peerAccuracy: 0,
            ...
            optionPercentages: {},
            staticData: {
                'PART1_VII_1': { image: '/images/PART1_VII_1.png', difficulty: '★★' },
                'PART1_VII_2': { image: '/images/PART1_VII_2.png', difficulty: '★★' },
                'PART1_VII_3': { image: '/images/PART1_VII_3.png', difficulty: '★★' },
                'PART1_VII_4': { image: '/images/PART1_VII_4.png', difficulty: '★★' },
                'PART1_VII_5': { image: '/images/PART1_VII_5.png', difficulty: '★★' },
                'PART1_VII_6': { image: '/images/PART1_VII_6.png', difficulty: '★★' }
            },
            classOptions: []
        };
    },
        ...
        highlightText(text, highlightText) {
            ...
            return Array.from(text).map(char => {
                if (highlightText.includes(char)) {
                  if(char == '0')
                    return `<span class="highlighted">哭脸</span>`;
                  else if(char == '1')
                    return `<span class="highlighted">笑脸</span>`;
                }
                if(char == '0')
                  return "哭脸";
                else if(char == '1')
