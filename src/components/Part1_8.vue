<template>
    <div>
        <h2>Ⅷ. Listen and judge（听一听，判断下列句子是否符合听到的内容，用T或F表示）：【语篇-句和句】</h2>
    ...
    data() {
        return {
            ...
            questionDescriptions: {
                'PART1_VIII_1': '(   ) 1. Jack is my little brother.',
                'PART1_VIII_2': '(   ) 2. Jack’s eyes are small.',
                'PART1_VIII_3': '(   ) 3. Jack likes going to the park and the zoo.',
                'PART1_VIII_4': '(   ) 4. Jack can read and write.',
            },
            classOptions: []
        };
    },
