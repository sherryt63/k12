<template>
    <div class="main">
      <header class="header">
        <h2>Ⅷ. Listen and judge（听一听，判断下列句子是否符合听到的内容，用T或F表示）：</h2>
        <h2>【语篇-句和句】</h2>
        <div class="menu">
...
export default {
    data() {
        return {
            questions: ['PART1_VIII_1', 'PART1_VIII_2', 'PART1_VIII_3', 'PART1_VIII_4'],
            listeningText: '',
            correctAnswer: '',
            studentAnswer: '',
            peerAccuracy: 0,
            ...
            optionPercentages: {},
            staticData: {
                'PART1_VIII_1': { difficulty: '★★' },
                'PART1_VIII_2': { difficulty: '★★' },
                'PART1_VIII_3': { difficulty: '★★' },
                'PART1_VIII_4': { difficulty: '★★' },
            },
            questionDescriptions: {
                'PART1_VIII_1': 'Jack is my little brother.',
                'PART1_VIII_2': "Jack's eyes are small.",
                'PART1_VIII_3': 'Jack likes going to the park and the zoo.',
                'PART1_VIII_4': 'Jack can read and write.',
            },
            classOptions: []
        };
    },
