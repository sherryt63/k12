<template>
    <div class="main">
      <header class="header">
        <h2>Ⅱ. Look and write（根据图意，写出相应的单词完成句子）：</h2>
        <h2>【词汇-词义】</h2>
        <div class="menu">
...
export default {
    data() {
        return {
            ...
            optionPercentages: {},
            staticData: {
                'PART2_II_1': { image: '/images/PART2_II_1.png', difficulty: '★★' },
                'PART2_II_2': { image: '/images/PART2_II_2.png', difficulty: '★★' },
                'PART2_II_3': { image: '/images/PART2_II_3.png', difficulty: '★★' },
                'PART2_II_4': { image: '/images/PART2_II_4.png', difficulty: '★★' },
                'PART2_II_5': { image: '/images/PART2_II_5.png', difficulty: '★★' }
            },
