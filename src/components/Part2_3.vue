<template>
    <div class="main">
      <header class="header">
        <h2>Ⅲ. Read and judge（判断划线部分发音，相同的用“T”表示，不同的用“F”表示）：</h2>
        <h2>【语音-基本读音】</h2>
        <div class="menu">
...
export default {
    data() {
        return {
            ...
            optionPercentages: {},
            staticData: {
                'PART2_III_1': { difficulty: '★★' },
                'PART2_III_2': { difficulty: '★★' },
                'PART2_III_3': { difficulty: '★★' },
                'PART2_III_4': { difficulty: '★★' },
            },
            questionDescriptions: {
                'PART2_III_1': '<u>ch</u>ick  &nbsp;&nbsp;<u>sh</u>op',
                'PART2_III_2': '<u>wh</u>ite  &nbsp;&nbsp;<u>wh</u>o',
                'PART2_III_3': 'sm<u>al</u>l  &nbsp;&nbsp;sh<u>or</u>t',
                'PART2_III_4': 'b<u>u</u>sy  &nbsp;&nbsp;p<u>i</u>nk',
            },
            classOptions: []
        };
    },
