<template>
    <div>
        <h2>Ⅶ. Read and write（用适当的单词填空，使句子完整，首字母已给）：【词汇-词义】</h2>
...
export default {
    data() {
        return {
            ...
            optionPercentages: {},
            staticData: {
                'PART2_VII_1': { difficulty: '四颗星' },
                'PART2_VII_2': { difficulty: '四颗星' },
                'PART2_VII_3': { difficulty: '四颗星' },
                'PART2_VII_4': { difficulty: '四颗星' },
                'PART2_VII_5': { difficulty: '四颗星' }
            },
            questionDescriptions: {
                'PART2_VII_1': '1. It’s a toy. It’s hard and smooth. It’s cold. It can walk and sing.It’s a r__________.',
                'PART2_VII_2': '2. We like h__________a picnic in spring.',
                'PART2_VII_3': '3. In summer people like to go to the b________ to make sandcastles.',
                'PART2_VII_4': '4. A tortoise can’t run fast. He can run s__________ .',
                'PART2_VII_5': '5. I can see with my e__________.They are big and bright.',
            },
            classOptions: []
        };
    },
