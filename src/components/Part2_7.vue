<template>
    <div class="main">
      <header class="header">
        <h2>Ⅶ. Read and write（用适当的单词填空，使句子完整，首字母已给）：</h2>
        <h2>【词汇-词义】</h2>
        <div class="menu">
      ...
      <div class="question-wrapper">  
        <div class="left-column"> 
          ...
          <div v-if="questionDescriptions[question]">
                <p style="font-size:18px;line-height:1.8">题目描述：{{ questionDescriptions[question] }}</p>
            </div>
          <!-- 正确答案 -->
...
export default {
    data() {
        return {
            questions: ['PART2_VII_1', 'PART2_VII_2', 'PART2_VII_3', 'PART2_VII_4', 'PART2_VII_5'],
            listeningText: '',
            correctAnswer: '',
            studentAnswer: '',
            peerAccuracy: 0,
            ...
            optionPercentages: {},
            staticData: {
                'PART2_VII_1': { difficulty: '★★★★' },
                'PART2_VII_2': { difficulty: '★★★★' },
                'PART2_VII_3': { difficulty: '★★★★' },
                'PART2_VII_4': { difficulty: '★★★★' },
                'PART2_VII_5': { difficulty: '★★★★' }
            },
            questionDescriptions: {
                'PART2_VII_1': "It's a toy. It's hard and smooth. It's cold. It can walk and sing. It's a r__________.",
                'PART2_VII_2': 'We like h__________a picnic in spring.',
                'PART2_VII_3': 'In summer people like to go to the b________ to make sandcastles.',
                'PART2_VII_4': "A tortoise can't run fast. He can run s__________ .",
                'PART2_VII_5': 'I can see with my e__________. They are big and bright.',
            },
            classOptions: []
        };
    },
