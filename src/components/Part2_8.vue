<template>
    <div class="main">
      <header class="header">
        <h2>Ⅷ.Read and judge（阅读短文，判断正误，用T或F表示）：</h2>
        <h2>【语篇-句和句】</h2>
        <div class="menu">
      ...
      <p style="font-size:23px">This is a photo of my good friend. He is Jack. 
      He is eight years old. He lives near the big park. 
      He likes going to the park on foot. And he likes riding a bicycle in the park. 
      He has a little brother, Ben. He's only four years old. 
      He's lovely. He can't read or write. But he can sing and dance. 
      Jack and Ben love each other. They often play together. They are very happy.</p>
      </div>
        ...
        <div class="right-column table-container"> 
          ...
          <div v-if="permission === '1'">
            ...
            <tr>
              ...
              <td style="width: 33.333%; text-align: center; color: black; font-size:17px" v-for="(option, optIndex) in options" :key="optIndex">
                <span v-html="highlightText(option.text, questionData[question]?.correctAnswer)"></span>
              </td>
            </tr>
            <tr>
              <td colspan=3 style="color: black; font-size:17px"><p class="option-percentages-container">&nbsp;&nbsp;&nbsp;&nbsp;学生答案：{{ questionData[question]?.studentAnswer }}</p>
    ...
    data() {
        return {
            ...
            questionDescriptions: {
                'PART2_VIII_1': "Jack is four years old.",
                'PART2_VIII_2': "Jack's home is near the big park.",
                'PART2_VIII_3': "Ben can read a book.",
                'PART2_VIII_4': "Jack and Ben are happy.",
            },
            classOptions: []
        };
    },
